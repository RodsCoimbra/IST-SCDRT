#ifndef __85qzIhcwNmRLBIOOWogW5B_h__
#define __85qzIhcwNmRLBIOOWogW5B_h__
...
#include <time.h>
#include <time.h>
#ifndef struct_tag_s3IEoOEzmWfHdqYldDQhLvB
#define struct_tag_s3IEoOEzmWfHdqYldDQhLvB

struct tag_s3IEoOEzmWfHdqYldDQhLvB
{
  uint32_T seed;
  uint32_T normaltransform;
  uint32_T parameters;
};

#endif                                 /* struct_tag_s3IEoOEzmWfHdqYldDQhLvB */

#ifndef typedef_s3IEoOEzmWfHdqYldDQhLvB
#define typedef_s3IEoOEzmWfHdqYldDQhLvB

typedef struct tag_s3IEoOEzmWfHdqYldDQhLvB s3IEoOEzmWfHdqYldDQhLvB;

#endif                                 /* typedef_s3IEoOEzmWfHdqYldDQhLvB */
...
#ifndef typedef_coder_internal_mt19937ar_1
#define typedef_coder_internal_mt19937ar_1

typedef struct tag_IXZbk4aPjQFR6fO0q1hmvH coder_internal_mt19937ar_1;

#endif                                 /* typedef_coder_internal_mt19937ar_1 */
...
#ifndef typedef_coder_internal_mt19937ar
#define typedef_coder_internal_mt19937ar

typedef struct tag_2SMHDelJvNeqNrZ7Atn6QB coder_internal_mt19937ar;

#endif                                 /* typedef_coder_internal_mt19937ar */

#ifndef struct_tag_QDxs8j2rMoCFgXOj6XQzLC
#define struct_tag_QDxs8j2rMoCFgXOj6XQzLC

struct tag_QDxs8j2rMoCFgXOj6XQzLC
{
  coder_internal_mt19937ar *Generator;
  coder_internal_mt19937ar MtGenerator;
};

#endif                                 /* struct_tag_QDxs8j2rMoCFgXOj6XQzLC */

#ifndef typedef_coder_internal_RandStream
#define typedef_coder_internal_RandStream

typedef struct tag_QDxs8j2rMoCFgXOj6XQzLC coder_internal_RandStream;

#endif                                 /* typedef_coder_internal_RandStream */
...
#ifndef struct_tag_3biGLprW5IV6MVVjXmRGQF
#define struct_tag_3biGLprW5IV6MVVjXmRGQF

struct tag_3biGLprW5IV6MVVjXmRGQF
{
  ...
  real_T pStd;
  coder_internal_RandStream pStream;
};

#endif                                 /* struct_tag_3biGLprW5IV6MVVjXmRGQF */

#ifndef typedef_comm_internal_AWGNChannel
#define typedef_comm_internal_AWGNChannel

typedef struct tag_3biGLprW5IV6MVVjXmRGQF comm_internal_AWGNChannel;
...
#ifndef struct_tag_V9LuXQV2PAj6fRCWiezRxF
#define struct_tag_V9LuXQV2PAj6fRCWiezRxF

struct tag_V9LuXQV2PAj6fRCWiezRxF
{
  char_T f1[4];
  char_T f2[15];
  char_T f3[10];
...
#endif                                 /* struct_tag_V9LuXQV2PAj6fRCWiezRxF */

#ifndef typedef_i_cell
#define typedef_i_cell

typedef struct tag_V9LuXQV2PAj6fRCWiezRxF i_cell;

#endif                                 /* typedef_i_cell */

#ifndef struct_tag_4uvGTEjvHQUqIbuB33mmHB
#define struct_tag_4uvGTEjvHQUqIbuB33mmHB

struct tag_4uvGTEjvHQUqIbuB33mmHB
{
  char_T f1[15];
  char_T f2[12];
  char_T f3[15];
...
#endif                                 /* struct_tag_4uvGTEjvHQUqIbuB33mmHB */

#ifndef typedef_j_cell
#define typedef_j_cell

typedef struct tag_4uvGTEjvHQUqIbuB33mmHB j_cell;
...
#ifndef struct_tag_8Fj8Jt25jaiRsiQx6frnwH
#define struct_tag_8Fj8Jt25jaiRsiQx6frnwH

struct tag_8Fj8Jt25jaiRsiQx6frnwH
{
  i_cell _data;
};

#endif                                 /* struct_tag_8Fj8Jt25jaiRsiQx6frnwH */

#ifndef typedef_s_8Fj8Jt25jaiRsiQx6frnwH
#define typedef_s_8Fj8Jt25jaiRsiQx6frnwH

typedef struct tag_8Fj8Jt25jaiRsiQx6frnwH s_8Fj8Jt25jaiRsiQx6frnwH;

#endif                                 /* typedef_s_8Fj8Jt25jaiRsiQx6frnwH */

#ifndef struct_tag_7xbvANdg7KAufDVBBSkgZE
#define struct_tag_7xbvANdg7KAufDVBBSkgZE

struct tag_7xbvANdg7KAufDVBBSkgZE
{
  j_cell _data;
};

#endif                                 /* struct_tag_7xbvANdg7KAufDVBBSkgZE */

#ifndef typedef_s_7xbvANdg7KAufDVBBSkgZE
#define typedef_s_7xbvANdg7KAufDVBBSkgZE

typedef struct tag_7xbvANdg7KAufDVBBSkgZE s_7xbvANdg7KAufDVBBSkgZE;

#endif                                 /* typedef_s_7xbvANdg7KAufDVBBSkgZE */

#ifndef typedef_coder_internal_RngNt
#define typedef_coder_internal_RngNt

typedef int32_T coder_internal_RngNt;

#endif                                 /* typedef_coder_internal_RngNt */
...
#ifndef typedef_InstanceStruct_85qzIhcwNmRLBIOOWogW5B
#define typedef_InstanceStruct_85qzIhcwNmRLBIOOWogW5B
...
#endif                                 /* typedef_InstanceStruct_85qzIhcwNmRLBIOOWogW5B */
...
extern void method_dispatcher_85qzIhcwNmRLBIOOWogW5B(SimStruct *S, int_T method,
  void* data);
